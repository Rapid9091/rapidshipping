 <section class="all-state-name-page-main">
     <h2 class="services-main-heading-big">
         Auto Shipping States in USA
     </h2>
     <section class="all-state-name-page">
         <div class="all-state-name-grid">
             ...
             <a href="<?= get_state() ?>/colorado" rel="dofollow">Colorado</a><br>
         ...
         <div class="all-state-name-grid">
             ...
             <a href="<?= get_state() ?>/pennsylvania">Pennsylvania</a><br>
             <a href="<?= get_state() ?>/rhode-island">Rhode Island</a><br>
             <a href="<?= get_state() ?>/south-carolina">South Carolina</a><br>
