            ...
            <div class="comapny-info">
                ...
                <div class="important-urls">
                    <div class="important-urls-grid">
                        <div class="important-urls-grid-1"><a href="<?= home_path(); ?>">Home</a></div>
                        <div class="important-urls-grid-1"><a href="<?= home_path(); ?>services">Services</a></div>
                        <div class="important-urls-grid-1"><a href="<?= home_path(); ?>blogs">Blogs</a></div>
                        <div class="important-urls-grid-1"><a href="<?= home_path(); ?>states">States</a></div>
    ...
    <div class="footer-urls-grid">
        ...
        <div class="footer-urls-grid-1">
            ...
            <ul> 
                ...
                <li><a href="<?= home_path(); ?>state-to-state/mexico-to-arizona">New mexico to arizona</a></li>
