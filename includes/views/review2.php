            ...
            <div class=" owl-carousel owl-theme" id="google_reviews">
                <div class="review-item item">
                    <div class="flex" style="justify-content: space-between;">
                        ...
                        <div class="" style="margin-top:10px;">
                            <img src="<?=get_img();?>TransportReviewsLogo.png" alt="transposrt review logo" style="width:80px;">
                        </div>
                    </div>
                    <div class="review_stars">
                        <p><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i
                ...
                <div class="review-item item">
                    <div class="flex" style="justify-content: space-between;">
                        ...
                        <div class="" style="margin-top:10px;">
                            <img src="<?=get_img()?>rapid-auto-shipping-crunchbase.png" alt="crunchbase logo" style="width:70px;">
                        </div>
                    </div>
                    <div class="review_stars">
                        <p><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i
                ...
                <div class="review-item item">
                    <div class="flex" style="justify-content: space-between;">
                        ...
                        <div class="" style="margin-top:10px;">
                            <img src="<?=get_img()?>Trustpilot-logo.png" alt="trustpilot" style="width:80px">
                        </div>
                    </div>
                    <div class="review_stars">
                        <p><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i
                ...
                <div class="review-item item">
                    <div class="flex" style="justify-content: space-between;">
                        ...
                        <div class="" style="margin-top:10px;">
                            <img src="<?=get_img()?>TransportReviewsLogo.png" alt="transport review" style="width:80px;">
                        </div>
                    </div>
                    <div class="review_stars">
                        <p><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i class='bx bxs-star'></i><i
