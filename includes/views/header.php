...
<header class="header">
    ...
    <div class="header-nav">
        ...
        <div class="header-logo">
            <a href="<?= home_path() ?>"><img loading="lazy" src=" <?= get_img() ?>Untitled-1-Recovered.png"
                    alt="Rapid Auto Shipping - Logo" loading="lazy" /></a>
        </div>
        <!-- -home-service-etc -->
        <div class="header-menu" id="header-menu">
            ...
            <button onclick="window.location.href=' tel:+1 833-233-4447'" class="number heart" style="cursor:pointer;">
                <i class='bx bxs-phone'></i>+1 (833) 233-4447
            </button>
