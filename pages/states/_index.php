...
<head>
    ...
    <style>
        ...
        @media screen and (max-width:768px){
            .major-city-code{text-align:center;grid-template-columns:1fr;font-size:15px;margin-bottom:20px}
            .major-city-code span{display:none}
...
<body>
    ...
    <div class="">
        ...
        <h2 class="alabama-city-code-heading" style="text-transform:capitalize">
            Popular Auto Transportation <span>Cities</span> In
            <?= $data['slug'];?>
        </h2>
        <?php
