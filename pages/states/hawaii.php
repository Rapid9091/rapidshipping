...
<body>
    ...
    <section class="two-california-state " id="famous_attracions_in_hawaii">
        ...
        <p class=" text">
            <a target="_blank" href="https://www.gousa.in/state/hawaii" title="Best Auto Transport Company In Hawaii"><span class="california-state-span"><b>Hawaii</b></span></a> is a state in the United States of America that is located on an island. Hawaii is the only state in the United States that is entirely made of islands, which necessitates a unique approach to vehicular transportation. Honolulu is the state's largest city and the state's most popular shipping port.
        </p>
