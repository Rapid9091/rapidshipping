...
<body>
    ...
    <div class="contact-us-header-page">
        <?php
        $NAME = "TERMINAL TO TERMINAL AUTO SHIPPING in USA";
        $PARAGRAPH = "  When you send your car from one terminal to another, this is known as terminal-to-terminal auto shipping. That's the only thing there is to the definition. Of course, understanding and being aware of a wide range of facts on the subject goes much beyond simply knowing the term.";
        include small_form;
        ?>
    </div>
    <!-- -------------------------------------- -->
