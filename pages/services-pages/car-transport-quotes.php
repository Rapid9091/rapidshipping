...
<body>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            REGULAR ROUTES VS POPULAR ROUTES
        </h2>
        <p>
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main">
                RAPID AUTO SHIPPING PROVIDES CAR SHIPPING QUOTES
            </h2>
            <p>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            HOW DO I GET QUOTES FOR CAR SHIPPING?
        </h2>
        <p>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            QUOTES FOR INTERNATIONAL CAR SHIPPING
        </h2>
        <p>
