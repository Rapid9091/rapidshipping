                ...
                <ul>
                    <li id="1">
                        <div class="shipping-form-state-content">
                            <h2 class="heading-1">Transport Of Common International <span>Equipment And Machinery</span></h2>
                            <ul style="margin-left:13px">
                                <li style="list-style-type:disc;">Oil Rigs, Cranes, Standpipes, and Derricks</li>
                                <li style="list-style-type:disc;"> Excavation Equipment: Backhoes, Bulldozers, Dump Trucks, and Other Equipment</li>
                                <li style="list-style-type:disc;">Performance Gear, Rigging, and Staging</li>
                                <li style="list-style-type:disc;">Sports Equipment for Exhibition Games and Tournaments</li>
                                <li style="list-style-type:disc;">Heavy Equipment for Various Projects</li>
                                <li style="list-style-type:disc;">Industrial Cranes</li>
                                <li style="list-style-type:disc;">Oversize Heavy Equipment</li>
                                <li style="list-style-type:disc;">Construction Gear: Boom Lifts, Cranes, and Scaffolding</li>
                                <li style="list-style-type:disc;">Agricultural Equipment: Combines, Tractors, Harvest</li>
                            </ul>
                    ...
                    <li id="2">
                        <div class="shipping-form-state-content">
                            <h2 class="heading-1">International Break <span>Bulk Shipping</span></h2>

                            <p class="para-2">Equipment that must be loaded separately into a cargo plane or ship is referred to as breakbulk, as opposed to equipment and goods that are placed into containers. Most of these services must be contracted individually because of the odd shapes of many breakbulk goods and their tremendous weight. Breakbulk transportation is inconvenient — and costly! Rapid Auto Shipping is the company to call if you need your crop plane, oil rig, or construction crane serviced.
