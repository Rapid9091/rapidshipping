...
<body>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            LOWBOY TRANSPORTATION FOR ALL HEAVY EQUIPMENT AND MACHINERY
        </h2>
        <p>
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main">LOWBOY TRAILER SHIPPING in all STATES
            </h2>
            <p class="services-subtheory-lines-small">
                Lowboy hauling is available in all 50 states, including Alaska and Hawaii. Lowboy trailers can be found at some of the best prices at online auctions. The disadvantage of buying trailers online is that you will need to arrange for reliable transportation for any new trailers you purchase. There's no need to be concerned with Rapid Auto Shipping. We provide high-quality lowboy trailer transportation throughout the United States. We'll get you any permits or escorts you need to safely and quickly transport your lowboy trailer wherever you need it. And, don't worry, you'll be in constant contact with your transportation team. You can count on us to deliver high-quality lowboy trailer transport.
            </p>
        </div>
        <div class="military-shipping-sixth-section-img">
            <img src="<?= get_img() ?>lowboy-service-car.jpeg" alt="lowboy shipping" />
        </div>
    </section>
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            WE ARE YOUR LOWBOY HAULING EXPERTS.
        </h2>
        <p>
            ...
            <br> If any more services are required.
            <br> Your load consultant will evaluate the cost of shipping your freight and begin the planning process. The following are some of your logistics agent's responsibilities:

            <br> Choosing the best mode of transport for your cargo.
            <br> Hiring a driver and any additional workers that may be required.
            <br> Creating a path between points A and B.
            <br> Assisting with paperwork and permit applications.
            <br> Communication with clients and transportation specialists.
            <br> Using problem-solving techniques to handle issues that arise during transportation.
            <br> Assuring that your cargo arrived at its destination on time.
            <br>We also offer lowbed trucking.
