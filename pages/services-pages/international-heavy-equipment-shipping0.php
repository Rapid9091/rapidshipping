...
<body>
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main">
                INTERNATIONAL BREAK BULK SHIPPING
            </h2>
            <p class="services-subtheory-lines-small">
                Equipment that must be loaded separately into a cargo plane or ship is referred to as breakbulk, as opposed to equipment and goods that are placed into containers. Most of these services must be contracted individually because of the odd shapes of many breakbulk goods and their tremendous weight. Breakbulk transportation is inconvenient — and costly! Rapid Auto Shipping is the company to call if you need your crop plane, oil rig, or construction crane serviced.
                <br>
                Breakbulk shipping includes cargo in bags, drums, and barrels. Rapid Auto Shipping can load your products onto a suitably rated boat with all necessary safety precautions for a reasonable price. We've transported baled commodities, barrels and casks, liquid-filled drums, palletized things, and even paper reels.
            </p>
        </div>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            INTERNATIONAL SHIPPING CONTAINER TRANSPORT
        </h2>
        <p>
            International container shipping, often known as ocean freight shipping, entails commodities being packed in containers and transported along predetermined routes. Fixed route freight services can assist corporations and other large entities in shipping a significant number of items from one port to another. While this isn't the quickest means to transport goods, it has shown to be dependable and efficient in moving your equipment or consumer items from one port to the next.
            <br>
            Your equipment is loaded and sealed into shipping containers before being delivered to its final destination in transport-ready containers that can be transported by rail or vehicle overland. Customer freight shipments overseas can be avoided by using Rapid Auto Shipping to help move smaller items in container shipments.
        </p>
    </section>
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            RAPID AUTO SHIPPING OVERSEAS MACHINERY TRANSPORT SERVICES HEAVY HAULERS PORT-TO-PORT

        </h2>
        <p>
            Rapid Auto Shipping's team consists of experienced master mariners and senior employees who can properly handle difficult port operations. To import and export your heavy equipment cargo safely, Rapid Auto Shipping uses advanced tracking technology and only works with reputable break bulk companies. We only provide water transportation; we do not provide land transit.
            <br>
            We'll load your heavy equipment, either as a breakbulk cargo or disassembled and in containers, then secure it to prevent damage and protect our workers and yours. Transport charges, customs taxes, and any paperwork required to get your equipment from one port to another are all included in Rapid Auto Shipping' service. Our logistics experts maintain track of the weather and provide you with real-time updates so that your overland transport services are ready when your equipment arrives in port. We can easily transfer your heavy machines across international borders.
        </p>
    </section>
