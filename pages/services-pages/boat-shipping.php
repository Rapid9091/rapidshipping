...
<body>
    ...
    <section class="first-sub-service-page">
        ...
        <p>
            ...
            It makes no difference if you own a large company that sells boats or if you simply enjoy collecting them. Rapid Auto Shipping is unconcerned about your cause for needing Boat Transport, and we want to know how we can help you. Our goal is to figure out the specifics of your Boat request and how we can assist you. We feel we are the best transportation service providers in the United States, and Boat is no exception. When it comes to Boat Transport, Rapid Auto Shipping has a lot of experience. We recognize that it is distinct from other modes of automobile transportation, which is why Rapid Auto Shipping takes extra precautions and is well-versed in the process!
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            Know more about Boat Shipping cost
        </h2>
        <p>
            These questions will aid Rapid Auto Shipping in comprehending the specifics of your request. It will assist us in determining what you expect from Rapid Auto Shipping and in determining what resources we will need to arrange for Transport. Finally, it will assist Rapid Auto Shipping in providing you with an accurate quote for your Transport request. Remember that if a company quotes you at a very low price, you should be suspicious. Frequently, businesses will portray their charges as cheaper than they are, and when the request is completed, they will reveal data about hidden costs. This is something Rapid Auto Shipping would never do to you.
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main">
                Shipping Information for Boats
            </h2>
            <p>
        ...
        <div class="military-shipping-sixth-section-img">
            <img src="<?= get_img() ?>blue-boat-clouds.png" alt="Boat shipping" />
        </div>
    </section>
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            About Small Boat Transport
        </h2>
        <p>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            Knowledge on Boat Shipping in General
        ...
        <p>
            ...
            The cords should be tied off and the batteries should be disconnected. Battery-operated engine hatch covers should be fastened to prevent them from opening during transport.
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            Ways to register your boat for shipping?
        </h2>
        <p>
