...
<body>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            WHAT YOU'RE SHIPPING WITH AUTO AUCTION SHIPPING SERVICES
        </h2>
        <p>
    ...
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            ...
            WHEN SHIPPING FROM AN AUCTION, HERE'S WHAT WE'LL NEED FROM YOU.
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main"> WE WORK WITH VARIOUS AUCTIONS
            </h2>
        ...
        <div class="military-shipping-sixth-section-img">
            <img src="<?= get_img() ?>GettyImages-0-1.png" alt="auto auction car shipping" />
