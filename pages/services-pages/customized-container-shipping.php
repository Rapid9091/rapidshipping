...
<head>
    ...
    <meta property="article:tag" content="custom containers" />
    ...
    <style>
        .contact-us-header-page {
            ...
            background-image: url('<?= get_img() ?>background-bg-1.jpg');
        ...
        <div class="left-state-to-state">
            ...
            <div class="points-div " id="top-section">
                ...
                <ul class="points-div-ul">
                    ...
                    <li><a href="#3">determine the best custom shipping containers transport services</a></li>
                    <li><a href="#4">hauling services for custom shipping containers in their entirety</a></li>
            ...
            <section class="first-state-to-state">
                <div class="shipping-form-state-image">
                    <img loading="lazy" src="https://res.cloudinary.com/dsmsqwx6q/image/upload/v1674287987/Recent%20Uploads/cutomized-container-shipping-truck-01.jpg" alt="Customised Shipping Containers (RAS)" />
                ...
                <ul>
                    ...
                    <div class="shipping-form-state-image">
                        <img loading="lazy" src="https://res.cloudinary.com/dsmsqwx6q/image/upload/v1674288064/Recent%20Uploads/cutomized-container-shipping-truck-02.jpg" alt="Customised Shipping Containers" />
                    </div>
                    <li id="3">
                        <div class="shipping-form-state-content">
                ...
                <div class="shipping-form-state-image">
                    <img loading="lazy" src="https://res.cloudinary.com/dsmsqwx6q/image/upload/v1674287912/Recent%20Uploads/cutomized-container-shipping-truck.jpg" alt="Customised Shipping Containers" />
                </div>
            </section>
