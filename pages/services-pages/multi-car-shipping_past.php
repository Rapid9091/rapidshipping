...
<body>
    ...
    <!-- new section under the first sectionca of single line -->
    <div class="contact-us-header-page">
        <?php
        $NAME = "Top Multi car shipping Services";
        $PARAGRAPH = " As a result, car shipping companies are happy to provide some of their most competitive prices to people and organisations that need many automobiles sent at the same time or to and from the same locations. In addition, when many cars are sent together, the truck driver chooses the shortest route to conserve petrol.";
        include small_form;
        ?>
    </div>
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            WE SHIP A VARIETY OF VEHICLES IN MULTIPLES.
        </h2>
        <p>
            <li style="list-style:disc !important"> Exotic, high-end, and high-value automobiles</li>
            <li style="list-style:disc !important"> Muscle cars and sports vehicles</li>
            <li style="list-style:disc !important"> Automobiles from the past (classic and vintage)</li>
            <li style="list-style:disc !important"> SUVs, pickup trucks, and trucks</li>
            <li style="list-style:disc !important"> Military personnel's vehicle</li>
            <li style="list-style:disc !important"> Motorcycles, Harley-Davidsons, and sport bikes are some of the most popular types of motorcycles.</li>
            <li style="list-style:disc !important"> Vehicles with all-terrain capabilities (ATVs)</li>
            <li style="list-style:disc !important"> High-performance automobiles and race cars</li>
            <br>These are just a few examples of the types of cars that are transported in groups on a regular basis. Larger vehicles, such as RVs, vans, yachts, and construction equipment, can also be transported in multiples. However, it is frequently dependent on their size and the equipment provided to the auto transport provider.
        </p>
    </section>
    <section class="first-sub-service-page">
        <h2 class="sub-service-heading-main">
            HOW MUCH TIME DOES IT TAKE A MULTIPLE CAR TRANSPORTER ACROSS THE BORDER?
        </h2>
        <p>
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main">MULTI-CAR SHIPPING
            </h2>
