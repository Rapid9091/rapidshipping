...
We'll go over the mechanics of motorbike shipping and what to expect when shipping your own. Let's start the celebrations!";
        include small_form;
        ?>
    </div>
    <section class="first-sub-service-page">
        ...
        <p>
            ...
            We'll go over how motorcycle shipping works as well as what to expect when shipping your own. Let's get this party started!<br>
    ...
    <section class="military-shipping-sixth-section">
        <div class="military-shipping-sixth-section-info">
            <h2 class="sub-service-heading-main">MOTORCYCLE SHIPPING USING OPEN TRANSPORT
            </h2>
            <p class="services-subtheory-lines-small">
                Are you considering transporting your Harley using an open motorcycle transport services? The double-decker carriers used by your dealer are open carriers. Furthermore, your motorcycle will be transported using cutting-edge technology and will arrive at its destination within seven days. Finally, open transport is a safe mode of transportation because your motorcycle will be shielded from road vibrations and jolts.</p>
        </div>
    ...
    <section class="first-sub-service-page">
        ...
        <p>
            ...
            You should definitely discuss additional options with your agent to make the cargo easier for them, the carrier, and yourself. Don't be hesitant to phone a few different companies and ask the same questions; you might get various replies.<br>
    ...
    <section class="first-sub-service-page">
        ...
        <p>
            ...
            Off the Beaten Path - If your destination is not on a major interstate route, you can expect to pay more for motorbike transportation. There are additional costs associated with exiting the freeway and travelling to an out-of-the-way location.<br>
    ...
    <section class="first-sub-service-page">
        ...
        <p>
            ...
            Time of Year: Some periods of the year are busier than others, and availability may be limited, notably during rallies and events. This implies you'll have to plan ahead of time and potentially add more time to your transportation itinerary than you had anticipated.<br>
